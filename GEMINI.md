...
| **IDEA-05** | 📸 스마트 화면 캡처 & Vision AI / OCR | 마우스 드래그 캡처 ➔ 자동 파일/클립보드 저장 ➔ AI 질문/에러 분석 & OCR 텍스트 추출 | **"괜찮음 (채택)"** (스크린샷 저장+클립보드 자동 저장 & AI 질문/OCR UI 파이프라인 수립) | 🚀 **채택 (다음 개발)** |
| **IDEA-06** | 📋 Smart 클립보드 매니저 | Ctrl+C 감지 ➔ 번역/웹요약/계산 퀵 액션 & 히스토리 | 스마트 클립보드 서포트 | 💡 아이디어 검토 |

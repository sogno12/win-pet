...
- [x] **진정한 엄지손톱 크기 '🔹 매우 작게 (32px)' 메뉴 옵션 추가**
...
- [x] **정면 바라보며 멍때리는 `idle/` 전용 픽셀 이미지 연동** (고양이 & 부엉이 정면 포즈)
- [x] **동물 5대 표준 에셋 폴더 스펙 적용** (`walk/`, `idle/`, `drag/`, `happy/`, `special/`)
- [x] **범용 펫 생성기 (`pet_generator.py`) 구축 및 동적 펫 스킨 스캐너 연동**
- [x] **신규 펫(호랑이 등) 추가 방법 README.md 문서화**
- [x] **펫 프레임 1:1 정방형 타이트 크롭(Tight-Crop) 적용으로 스케일 크기 불일치 완벽 수정**
